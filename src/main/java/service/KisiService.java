...
//    "yas": 66}
	public Kisi kisiGuncelle(Kisi guncelKisi) {
		//değiştirmek istediğimiz kişinin idsini yazmalıyız, istediğimiz id li kişi yoksa yeni kişi gibi ekliyor
	...
	public Kisi idIleKismiGuncelle(Integer id, Kisi yeniKisi) {
		...
		Kisi eskiKisi = kisiRepository.findById(id).
			orElseThrow( () -> new IllegalStateException(id + " li kisi bulunamadi"));
					          // alıcı nesnenin durumu nedeniyle yapılan çağrının olağandışı olması durumunda atılacak istisnadır.
